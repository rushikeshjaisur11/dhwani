...
function useSettingsInternal() {
  ...
  // Memoized on the store snapshot so the context value keeps its identity
  // between store changes — otherwise every settings write re-renders all
  // useSettings consumers through a fresh ~140-key object.
  return useMemo(
    () => ({
      ...
      polishEnabled: store.polishEnabled,
      setPolishEnabled: store.setPolishEnabled,
      polishInstructionConcise: store.polishInstructionConcise,
      setPolishInstructionConcise: store.setPolishInstructionConcise,
      polishInstructionClarity: store.polishInstructionClarity,
      setPolishInstructionClarity: store.setPolishInstructionClarity,
      polishInstructionTone: store.polishInstructionTone,
      setPolishInstructionTone: store.setPolishInstructionTone,
      polishInstructionStructure: store.polishInstructionStructure,
      setPolishInstructionStructure: store.setPolishInstructionStructure,
      polishKey: store.polishKey,
      setPolishKey: store.setPolishKey,
      styleToneWork: store.styleToneWork,
      setStyleToneWork: store.setStyleToneWork,
      styleToneEmail: store.styleToneEmail,
      setStyleToneEmail: store.setStyleToneEmail,
      styleTonePersonal: store.styleTonePersonal,
      setStyleTonePersonal: store.setStyleTonePersonal,
      styleToneOther: store.styleToneOther,
      setStyleToneOther: store.setStyleToneOther,
    ...
    [store, autoLearnCorrections, setAutoLearnCorrections]
  );
}
