...
/* Define GUIDs missing from standard libraries when compiling in C */
...
DEFINE_GUID(IID_IAudioSessionNotification, 0x641DD20B, 0x4D41, 0x49CC, 0xAB, 0xA3, 0x17, 0x4B, 0x94, 0x77, 0xB6, 0xC4);
